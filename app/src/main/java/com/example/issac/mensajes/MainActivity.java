package com.example.issac.mensajes;
...
public class MainActivity extends Activity {
    ...
    String datos[]={"Somos lo que pensamos. Todo lo que somos surge con nuestros pensamientos. Con nuestros pensamientos construimos el mundo.-Buddha.",
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(datos[randomNum]);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                randomNum = 0 + (int) (Math.random() * (datos.length-1));
                textView.setText(datos[randomNum]);
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //randomNum = 0 + (int) (Math.random() * datos.length);
                randomNum++;
                if(randomNum==datos.length){
                    randomNum=0;
                }
                textView.setText(datos[randomNum]);
